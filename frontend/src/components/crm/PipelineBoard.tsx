...
export function PipelineBoard() {
  ...
  return (
    <>
                  ...
                  {contacts.slice(0, 30).map((contact) => {
                    ...
                    return (
                      <div
                        ...
                        className="cursor-pointer rounded-lg border border-[var(--color-border)] bg-[var(--color-surface)] p-3 transition-colors hover:bg-[var(--color-surface-hover)]"
                      >
      ...
      {selected && (
        <ContactDetail contact={selected} onClose={() => setSelectedId(null)} onUpdated={refetch} />
      )}
    </>
  )
}
